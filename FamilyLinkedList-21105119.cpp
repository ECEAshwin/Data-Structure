...
int main(){
    ...
    Node*head=NULL;
	int family_member_number;
                        //Taking no of family mem as input
	cout<<"Enter Number Of Family Members:  ";
    cin>>family_member_number;
                        //Inserting family members details in doubly linked list
	for(int i=1;i<=family_member_number;i++){
		string name;
		int age;
		cout<<"Enter the Name of Family Member "<<i<<":  ";
        cin.ignore();getline(cin,name);
		cout<<"Enter the age of Family Member "<<i<<":  ";
        cin>>age;
